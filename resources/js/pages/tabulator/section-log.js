(function () {
    ...
    if ($("#tabulator").length) {
        const tabulator = new Tabulator("#tabulator", {
            //ajaxURL: "https://staff.ndcotabato.info/student-log-tabulator",
            ajaxURL: "https://staff.ndcotabato.info/section-log-tabulator",
            ajaxConfig: {
                method: "GET",
                mode: "cors",
        ...
        $("#tabulator-html-filter-submit-date").on("click", function (event) {
            ...
            const tabulator = new Tabulator("#tabulator", {
                //ajaxURL: "https://staff.ndcotabato.info/student-log-tabulator",
                ajaxURL:
                    "https://staff.ndcotabato.info/section-date-log-tabulator",
                ajaxParams: {
